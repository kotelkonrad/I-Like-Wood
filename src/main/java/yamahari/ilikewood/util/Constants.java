...
public class Constants {
    ...
    public static final ImmutableMap<WoodType, ResourceLocation> TEXTURE_CHEST =
    ...
    public static final ImmutableMap<WoodType, ResourceLocation> TEXTURE_CHEST_DOUBLE =
            (new ImmutableMap.Builder<WoodType, ResourceLocation>())
