...
public class WoodenScaffoldingItem extends WoodenBlockItem {
    public WoodenScaffoldingItem(Block blockIn) {
        super(blockIn, WoodenObjectType.SCAFFOLDING, new Item.Properties().group(ItemGroup.DECORATIONS));
    }
